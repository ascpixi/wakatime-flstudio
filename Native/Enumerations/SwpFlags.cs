...
/// <summary>
/// Specifies the options for the SetWindowPos function.
/// </summary>
[Flags]
public enum SwpFlags : uint
{
    ...
    /// result of the window being moved. When this flag is set, the application must explicitly invalidate or redraw 
